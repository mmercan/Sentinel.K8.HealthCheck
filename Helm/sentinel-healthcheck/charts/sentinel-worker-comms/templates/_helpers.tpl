...
*/}}
{{- define "sentinel-worker-comms.name" -}}
...
*/}}
{{- define "sentinel-worker-comms.fullname" -}}
...
*/}}
{{- define "sentinel-worker-comms.chart" -}}
...
*/}}
{{- define "sentinel-worker-comms.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "sentinel-worker-comms.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
